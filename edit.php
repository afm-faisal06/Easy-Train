        ...
        <form class="sign-up-main" action="code1.php" method = "post">
            <div class="two-part">
                <div class="all right-first right-back">
                    <h5>Train No.</h5>
                    <input type="text" placeholder="Train no." name = "id" required>
                    <h5>Name</h5>
                ...
                <div class="all right-last right-back">
                    ...
                    <h5>Cost</h5>
                    <input type="text" placeholder="Cost Tk" name = "cost" required>
                    <h5>Seat</h5>
                    <input type="text" placeholder="Seat" name = "seat" required>
                </div>
            </div>
            <div class="check">
